...
<li>[docs-python.ru](https://docs-python.ru/) и др.</li><br>
...
<li>Программирование на Python для абсолютных новичков. Кевин Уилсон и др.</li>
...
<b>Django.</b> Разработке приложения с применением фреймворка Django:<br>
...
Дополнительно была установлена библиотека pillow, для работы с изображениями.
...
В проект так же должны войти статические файлы в директории static для работ с изображениями, файл styles.css для рабботы со стилем веб-страницы, директория templates, с шаблонами HTML.
