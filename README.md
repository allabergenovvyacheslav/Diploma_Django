...
<li>models.py: Python-класс, который описывает структуру таблицы базы данных</li>
...
Реализван шаблон интернет-магазина с использованием Bootstrap, для уменьщения нагрузки на ресурс применил пагинацию с помощью класса Paginator.<br>
